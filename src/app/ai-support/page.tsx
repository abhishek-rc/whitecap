                                ...
                                {[1, 2, 3, 4, 5].map((index) => (
                                    <div key={index} className="bg-white rounded-lg shadow-sm border border-amber-100 p-4 animate-pulse">
                                        <div className="flex space-x-4">
                                            <div className="w-20 h-20 bg-gradient-to-r from-amber-200 to-orange-200 rounded-lg"></div>
                                            <div className="flex-1 space-y-2">
                                                <div className="h-4 bg-gradient-to-r from-amber-200 to-yellow-200 rounded w-3/4"></div>
                                                <div className="h-3 bg-gradient-to-r from-yellow-200 to-orange-200 rounded w-1/2"></div>
                                                <div className="h-3 bg-gradient-to-r from-orange-200 to-amber-200 rounded w-1/4"></div>
                                                <div className="flex space-x-2 mt-3">
                                                    <div className="h-6 bg-gradient-to-r from-amber-300 to-orange-300 rounded-full w-16"></div>
                                                    <div className="h-6 bg-gradient-to-r from-yellow-300 to-amber-300 rounded-full w-20"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
